...
const Dashboard = (() => {
  ...
  function renderSummary() {
    ...
    Utils.animateNumber(els.balance, s.balance, { formatFn: Utils.formatCurrency });
    Utils.animateNumber(els.totalIncome, s.income, { formatFn: Utils.formatCurrency });
    Utils.animateNumber(els.totalExpense, s.expense, { formatFn: Utils.formatCurrency });
  ...
  function renderIuranToday() {
    ...
    Utils.animateNumber(els.iuranTodayTotal, s.totalCollected, {
      formatFn: (v) => `${Utils.formatCurrency(v)} terkumpul`
    });
